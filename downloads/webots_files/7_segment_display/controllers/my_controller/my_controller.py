...
material_node = supervisor.getFromDef("f")  # Replace "f" with the actual DEF name
if material_node is None:
    print("Error: Node with DEF name 'f' not found! Please check the DEF name in your Webots scene tree.")
    exit()

print("Node successfully retrieved: 'f'")
