...
def goto_point_and_face_to(robot, gps, imu, wheels, x_goal, y_goal, face_to=(0.0, 0.0), speed=0.4, goal_threshold=0.15):
    """
    ...
    for w in wheels:
        w.setVelocity(0.0)
    print(f"[goto_point_and_face_to] 抵達 ({x_goal},{y_goal})")
